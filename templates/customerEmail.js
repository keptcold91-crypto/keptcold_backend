  ...
  <tr>
    <td align="center">
      ...
      <table width="600" cellpadding="0" cellspacing="0" border="0"
        ...
        <!-- ── CUSTOMER CONFIRMATION / TITLE / INTRO ────────────────────── -->
        <tr>
          <td style="padding:22px 28px 0;">
            ...
            <p style="margin:0 0 6px;font-size:13px;color:#555555;line-height:1.65;">
              Dear ${escapeHtml(data.contactName)},
            </p>
            <p style="margin:0 0 20px;font-size:13px;color:#555555;line-height:1.65;">
              Thank you for contacting Kept Cold. We have received your service
              request and our team will be in touch shortly to arrange an engineer
        ...
        <tr>
          <td style="padding:18px 28px;">
            <p style="margin:0 0 10px;font-size:12px;color:#555555;line-height:1.65;">
              A member of our team will contact you at the number or email address
              provided to confirm your engineer visit.
            </p>
            <p style="margin:0 0 14px;font-size:12px;color:#555555;line-height:1.65;">
              If you have any urgent questions, please call us on
              <strong>020 8146 3671</strong>.
            </p>
            <p style="margin:0;font-size:12px;color:#111111;line-height:1.65;">
              Kind regards,<br />
